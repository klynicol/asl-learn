...
echo "<h1>Register for account</h1>";
echo form_open('https://asl-learn.com/asl-server/index.php/bang/register');
echo form_input(['name' => 'first_name', 'placeholder' => "First Name"]);
echo form_input(['name' => 'last_name', 'placeholder' => "Last Name"]);
